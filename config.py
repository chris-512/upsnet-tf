...
config.network.pixel_means = np.array((
    102.9801,
    115.9465,
    122.7717,
))
...
# rpn
config.network.rpn_feat_stride = (
    4,
    8,
    16,
    32,
...
config.train.bbox_weights = np.array((
    1.0,
    1.0,
    1.0,
    1.0,
